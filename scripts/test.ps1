...
$testInvocation = 'npx sf apex run test --suite-names RoundRobinTestSuite --result-format human --wait 20 --code-coverage --output-dir ./tests/apex --concise'
...
function Start-Tests() {
  ...
  try {
    ...
    npx sf org delete scratch --no-prompt --target-org "$scratchOrgName"
  } catch {
